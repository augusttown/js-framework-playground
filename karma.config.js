// Karma configuration
// Generated on Tue May 31 2016 10:58:36 GMT-0400 (Eastern Daylight Time)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      //'unit-tests/chai.test.spec.js'
      //'unit-tests/basic.controller.spec.js'
    ],
    ...
    //
    htmlReporter: {
        outputDir: 'unit-tests', 				// where to put the reports
